...
# Load the image
image = cv2.imread('./output_images/Binary Character_5.jpg')  # Replace with your image file
# image = cv2.imread('1_upper_segmented.png')
...
cv2.imwrite('ResultSegmented.jpg', result_image)
